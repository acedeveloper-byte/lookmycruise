...
import terms from "../../components/utils/terms.json"
const page = () => {
    return (
        <>
            <Header />
            ...
            <div className="container mt-5">
                ...
                <section className="text-center my-5">
                    <h6 style={{ color: "#F16D1B" }}>Terms and conditions</h6>
                </section>
                ...
                <section>
                    ...
                    <div className="row align-items-center my-5">
                        <div className="col-md-12" dangerouslySetInnerHTML={{ __html: terms.html_terms }} />
